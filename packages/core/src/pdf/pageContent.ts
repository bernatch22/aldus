/**
 * pdf/pageContent.ts — reading and writing a page's content stream bytes via
 * pdf-lib (Layer 1). Trasplante VERBATIM de v1 bake/pageContent.ts.
 *
 * ⚠️ Este módulo importa pdf-lib: NO se exporta por el barrel público de core
 * (`.`) — solo lo consume el subpath ./bake (F3), que es la frontera pdf-lib.
 */
import {
  PDFArray,
  PDFDocument,
